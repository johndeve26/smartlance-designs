 ...
 */
const PRISMA_CLIENT_GENERATION = "prospect-experience-v1";
...
const REQUIRED_DELEGATES = [
  ...
  "agencyProposalClientAccess",
  "agencyProposalClientResponse",
  "agencyProposalAcceptance",
  "agencyProposalActivity",
  "agencyContractCounter",
  "agencyContractTemplate",
  "agencyContractTemplateVersion",
  "agencyContract",
  "agencyContractVersion",
  "agencyContractSigner",
  "agencyContractClientAccess",
  "agencyContractSignature",
  "agencyContractResponse",
  "agencyContractActivity",
  "agencyBillingSettings",
  "agencyBillingProfile",
  "agencyInvoiceCounter",
  "agencyPaymentCounter",
  "agencyBillingSchedule",
  "agencyBillingInstallment",
  "agencyInvoice",
  "agencyInvoiceLineItem",
  "agencyPayment",
  "agencyPaymentAllocation",
  "agencyPaymentWebhookEvent",
  "agencyRetainer",
  "agencyRetainerBillingPeriod",
  "agencyInvoiceClientAccess",
  "agencyClientBillingAccess",
  "agencyBillingActivity",
  "agencyOnboardingTemplate",
  "agencyOnboardingTemplateVersion",
  "agencyOnboardingTemplateSection",
  "agencyOnboardingTemplateQuestion",
  "agencyOnboardingTemplateRequirement",
  "agencyProjectOnboarding",
  "agencyOnboardingSection",
  "agencyOnboardingQuestion",
  "agencyOnboardingResponse",
  "agencyOnboardingFileSubmission",
  "agencyOnboardingActivity",
  "agencyOnboardingReminder",
  "agencyChangeRequestCounter",
  "agencyChangeRequest",
  "agencyChangeRequestRevision",
  "agencyChangeRequestAssessment",
  "agencyChangeRequestClientAccess",
  "agencyChangeRequestApproval",
  "agencyChangeRequestDecision",
  "agencyChangeRequestMessage",
  "agencyChangeRequestWorkItem",
  "agencyChangeRequestApplication",
  "agencyChangeRequestActivity",
  "agencyChangeRequestFile",
  "agencyProspectProfile",
  "agencyWebsiteReview",
  "agencyWebsiteReviewPage",
  "agencyWebsiteReviewEvidence",
  "agencyWebsiteReviewFinding",
  "agencyWebsiteReviewFindingEvidence",
  "agencyWebsiteBrief",
  "agencyProspectRequest",
  "agencyProspectRequestMessage",
  "agencyProspectRequestActivity",
  "agencyProspectRequestCounter",
] as const;
