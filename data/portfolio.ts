...
export const projects: Project[] = [
  {
    ...
    imageAlt: "Pàdéyá event platform homepage on desktop",
    heroImage: "/images/projects/padeya/hero.webp",
    heroImageAlt: "Pàdéyá event platform homepage on desktop",
    gallery: [
      {
  ...
  },
  {
    ...
    imageAlt: "Freelance OS marketing homepage on desktop",
    heroImage: "/images/projects/freelance-os/hero.webp",
    heroImageAlt: "Freelance OS marketing homepage on desktop",
    gallery: [
      {
        src: "/images/projects/freelance-os/discovery.webp",
        alt: "Freelance OS marketing homepage on mobile",
        layout: "full",
      },
      {
